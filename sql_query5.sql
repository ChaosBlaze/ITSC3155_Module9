...
SELECT
    a.first_name AS Instructor_First_Name,
    a.last_name AS Instructor_Last_Name,
    SUM(num_credits) AS Credit_Hours
FROM
	instructor a
	JOIN course c ON a.instructor_id = c.instructor_id
